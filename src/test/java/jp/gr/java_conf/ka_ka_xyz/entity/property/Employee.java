...
package jp.gr.java_conf.ka_ka_xyz.entity.property;
...
public class Employee extends Person{
    ...
    public Employee(){}
    public Employee(int id, String firstName, String lastName, String empId, String divisionName){
        setId(id);
    ...
    public String toString() {
        return super.toString() + "Employee [empId=" + empId + ", divisionName=" + divisionName
                + "]";
    }
}
